...
- 邮箱：kingswim404@gmail.com
  ...
  - 每个月的第一个周日15:00—17:00，正式开启新的一期学习，同时会在[我的斗鱼直播间](https://www.douyu.com/1639674)介绍如何更好的使用教程以及回答大家的一些问题。时间如果有调整会在下面的公众号里提前发布通知。一般会优先发布于：[教程学习数据统计及其计划](数据统计.md)
  
    <img src="imgs/KingSwim404.png" width="200" style="width:200px; float:left;"/>
    
  - [教程学习数据统计及其计划](数据统计.md)
